...
DROP TABLE IF EXISTS tracking_ids CASCADE;
...
DROP TABLE IF EXISTS user_tracking_assignments CASCADE;
...
DROP TABLE IF EXISTS tracking_id_audit_log CASCADE;
...
-- Step 5: Drop existing functions to recreate them
DROP FUNCTION IF EXISTS get_tracking_id_stats CASCADE;
DROP FUNCTION IF EXISTS bulk_upload_tracking_ids CASCADE;
